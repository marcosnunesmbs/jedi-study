# Phase Progress Display Specification

## Purpose
Visualização do progresso do aluno dentro de uma fase de estudos.

## Scope
O que está **incluído** nessa spec:
- Barra de progresso com percentual na página da fase

O que está **fora do escopo**:
- Progresso geral do subject (coberto em subject-progress)
